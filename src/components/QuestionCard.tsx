        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {/* LeetCode Button — show when a URL exists, else show unavailable for coding Qs */}
              {(() => {
                const url = question.leetcodeUrl || question.leetcodeLink;
                if (url) {
                  return (
                    <a
                      href={url}
                      ...
                      className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border transition-all hover:brightness-110 active:scale-95"
                      style={{
                        backgroundColor: 'rgba(255,161,22,0.10)',
                        borderColor: 'rgba(255,161,22,0.30)',
                        color: '#FFA116',
                      }}
                      title={`Practice on LeetCode: ${question.leetcodeUrl ? question.leetcodeSlug : ''}`}
                    >
                      {/* Official LeetCode icon */}
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="#FFA116" xmlns="http://www.w3.org/2000/svg">
                ...
                // For coding questions without a LC link, show unavailable label
